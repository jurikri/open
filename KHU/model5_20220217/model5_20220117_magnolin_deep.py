...
for SE in range(N):
    if not SE in [179, 181]: # ROI 매칭안되므로 임시 제거
        for se in range(MAXSE):
            ...
            if True:  # KHU_PSL_magnolin analgesic effects
...
settingID = 'model5_20220218_magnolin_deep'
...
vis.ms_report_khu_magnolin(mssave[:,:,1])
