...
project_list.append(['202011_withCFA_1', 100, None])
project_list.append(['202011_withCFA_2', 200, None])
project_list.append(['202011_withCFA_3', 300, None])
    ...
    def ms_sampling():
        ...
        for SE in range(N):
            if SE in trainingset:
                for se in range(5):      
                    # nonpain Group에 들어갈 수 있는 모든 경우의 수 
