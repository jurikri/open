        ...
        for se in range(MAXSE):
            ...
            if snu_chronic:
                ...
                if PSLsw:
                    ...
                    drugc.append(SE in ipsaline_pslGroup and se in [1,3])
            ...
            if khu_chronic:
                ...
                if PSLsw:
                    painc.append(SE in morphineGroup and se in [2,3,6,7])
                    drugc.append(SE in morphineGroup and se in [4,5,8,9])
...
settingID = 'model5_20220203_morphine_control'
